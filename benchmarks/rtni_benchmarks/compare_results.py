...
MAIN_COMPARABLE_ROWS = [
    ...
    row(
        intu_key="U_|trU|^4_d=10",
        rtni_key="U_|trU|^4_d=10",
        label="U(d), |tr(U)|⁴, d=10",
        group="U($d$)",
        integrand=r"$|tr(U)|^4$, $d=10$",
    ),
    row(
        intu_key="U_|trU|^6_d=10",
        rtni_key="U_|trU|^6_d=10",
        label="U(d), |tr(U)|⁶, d=10",
        group="U($d$)",
        integrand=r"$|tr(U)|^6$, $d=10$",
    ),
    row(
        intu_key="U_|trU|^8_d=10",
        rtni_key="U_|trU|^8_d=10",
        label="U(d), |tr(U)|⁸, d=10",
        group="U($d$)",
        integrand=r"$|tr(U)|^8$, $d=10$",
    ),
    row(
...
SUPPLEMENTARY_ROWS = [
    ...
    row(
        intu_key="U_|trU|^4_d=10_itensor",
        rtni_key=None,
        label="U(d) (ITensors), |tr(U)|⁴, d=10",
        group="U($d$) (ITensors)",
        integrand=r"$|tr(U)|^4$, $d=10$",
    ),
    row(
        intu_key="U_|trU|^6_d=10_itensor",
        rtni_key=None,
        label="U(d) (ITensors), |tr(U)|⁶, d=10",
        group="U($d$) (ITensors)",
        integrand=r"$|tr(U)|^6$, $d=10$",
    ...
    row(
        intu_key="U_|trU|^8_d=10_itensor",
        rtni_key=None,
        label="U(d) (ITensors), |tr(U)|⁸, d=10",
        group="U($d$) (ITensors)",
        integrand=r"$|tr(U)|^8$, $d=10$",
