...
\hline
Unitary & $|U_{11}|^6$ & Symbolic & 4.1 \\
Unitary & $|U_{11}|^8$ & Symbolic & 10.7 \\
Unitary & $|U_{11}|^{10}$ & Symbolic & 46.2 \\
Unitary & $|U_{11}|^{10}$ & $d=10$ & 4.4 \\
Unitary & $|U_{11}|^{10}$ & $d=50$ & 47.7 \\
\hline
Orthogonal & $O_{11}^6$ & $d=10$ & 0.3 \\
Orthogonal & $O_{11}^8$ & $d=20$ & 4.5 \\
Orthogonal & $O_{11}^{10}$ & $d=20$ & 372.5 \\
Orthogonal & $O_{11}^{10}$ & $d=50$ & 385.0 \\
\hline
Symplectic & $|S_{11}|^8$ & $d=10$ & 2.1 \\
Symplectic & $|S_{11}|^{10}$ & $d=10$ & 4.9 \\
Symplectic & $|S_{11}|^{10}$ & $d=20$ & 9.9 \\
\hline
Circ. Orthogonal & $|S_{11}|^2$ & Symbolic & 0.8 \\
Circ. Orthogonal & $|S_{11}|^4$ & Symbolic & 2.3 \\
Circ. Orthogonal & $|S_{11}|^6$ & Symbolic & 11.8 \\
Circ. Symplectic & $|S_{11}|^2$ & Symbolic & 0.8 \\
Circ. Symplectic & $|S_{11}|^4$ & Symbolic & 2.7 \\
Circ. Symplectic & $|S_{11}|^6$ & Symbolic & 81.7 \\
\hline
Permutation & $P_{11}^{10}$ & $d=100$ & 65.7 \\
Permutation & $\mathrm{tr}(PA)^2$ & $d=4$ & 24.3 \\
Centered Perm. & $Y_{11}^4$ & $d=10$ & 1.4 \\
\hline
...
high-degree moments such as $|S_{11}|^6$ are computed in under 100~ms.
...
Degree $k$ & 4 & 2 & 32.1 \\
\hline
Dimension $d$ ($k=2$) & 2 & 2 & 0.048 \\
Dimension $d$ ($k=2$) & 2 & 10 & 0.097 \\
Dimension $d$ ($k=2$) & 2 & 50 & 43.9 \\
Dimension $d$ ($k=2$) & 2 & 100 & 1279 \\
\hline
Dimension $d$ ($k=3$) & 3 & 2 & 0.876 \\
Dimension $d$ ($k=3$) & 3 & 10 & 10.5 \\
Dimension $d$ ($k=3$) & 3 & 20 & 1910 \\
Dimension $d$ ($k=3$) & 3 & 30 & 16800 \\
\hline
Orthogonal & 6 & 3 & 589.0 \\
\hline
\end{tabular}
\end{table}
